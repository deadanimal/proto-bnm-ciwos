...
@Component({
  selector: "app-user-recissuance-production-planner",
  templateUrl: "./user-recissuance-production-planner.component.html",
  styleUrls: ["./user-recissuance-production-planner.component.scss"],
})
export class UserRecissuanceProductionPlannerComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
  ...
  initCalendar() {
    this.calendar = new Calendar(
      document.getElementById("calendaruserissuanceproductionplanner1"),
      {
