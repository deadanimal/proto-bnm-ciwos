...
@Component({
  selector: "app-user-recissuance-production-personal",
  templateUrl: "./user-recissuance-production-personal.component.html",
  styleUrls: ["./user-recissuance-production-personal.component.scss"],
})
export class UserRecissuanceProductionPersonalComponent
  implements OnInit, OnDestroy
{
  ...
  getChartAdminIssuanceProductionPersonal1() {
    ...
    let chart = am4core.create(
      "chartdivuserissuanceproductionpersonal1",
      am4charts.XYChart
    );
