...
@Component({
  selector: "app-user-conlog-wms",
  templateUrl: "./user-conlog-wms.component.html",
  styleUrls: ["./user-conlog-wms.component.scss"],
})
export class UserConlogWmsComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
  ...
  initCalendar() {
    this.calendar = new Calendar(
      document.getElementById("calendaruserConsigmentLogisticWMS1"),
      {
