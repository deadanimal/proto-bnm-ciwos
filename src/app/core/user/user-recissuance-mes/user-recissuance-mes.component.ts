...
@Component({
  selector: "app-user-recissuance-mes",
  templateUrl: "./user-recissuance-mes.component.html",
  styleUrls: ["./user-recissuance-mes.component.scss"],
})
export class UserRecissuanceMesComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
  ...
  initCalendar() {
    this.calendar = new Calendar(
      document.getElementById("calendarUserReceivingIssuanceMES1"),
      {
