...
@Component({
  selector: "app-submission-reporting",
  templateUrl: "./submission-reporting.component.html",
  styleUrls: ["./submission-reporting.component.scss"],
})
export class SubmissionReportingComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
  ...
  getCharts() {
    this.zone.runOutsideAngular(() => {
      this.getChartSubmissionReport1();
      this.getChartSubmissionReport2();
      this.getChartSubmissionReport3();
      this.getChartSubmissionReport4();
      this.getChartSubmissionReport5();
      this.getChartSubmissionReport6();
    });
  }

  getChartSubmissionReport1() {
    am4core.useTheme(am4themes_dataviz);
    am4core.useTheme(am4themes_animated);
    // Themes end

    // Create chart instance
    let chart = am4core.create("chartdivadminsubmissionreport1", am4charts.XYChart);
  ...
  getChartSubmissionReport2() {
    am4core.useTheme(am4themes_dataviz);
    am4core.useTheme(am4themes_animated);
    // Themes end

    let chart = am4core.create("chartdivadminsubmissionreport2", am4charts.XYChart);
  ...
  getChartSubmissionReport3() {
    let chart = am4core.create("chartdivadminsubmissionreport3", am4charts.XYChart);
  ...
  getChartSubmissionReport4() {
    let chart = am4core.create("chartdivadminsubmissionreport4", am4charts.XYChart);
  ...
  getChartSubmissionReport5() {
    let chart = am4core.create("chartdivadminsubmissionreport5", am4charts.XYChart);
  ...
  getChartSubmissionReport6() {
    let chart = am4core.create("chartdivadminsubmissionreport6", am4charts.XYChart);
