...
@Component({
  selector: "app-receiving-issuance-production-planner",
  templateUrl: "./receiving-issuance-production-planner.component.html",
  styleUrls: ["./receiving-issuance-production-planner.component.scss"],
})
export class ReceivingIssuanceProductionPlannerComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
  ...
  initCalendar() {
    this.calendar = new Calendar(
      document.getElementById("calendarAdminissuanceproductionplanner1"),
      {
