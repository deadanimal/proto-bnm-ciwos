...
@Component({
  selector: "app-quality-approved-blank-coin",
  templateUrl: "./quality-approved-blank-coin.component.html",
  styleUrls: ["./quality-approved-blank-coin.component.scss"],
})
export class QualityApprovedBlankCoinComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
