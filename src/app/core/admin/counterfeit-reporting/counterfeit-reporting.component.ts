...
@Component({
  selector: "app-counterfeit-reporting",
  templateUrl: "./counterfeit-reporting.component.html",
  styleUrls: ["./counterfeit-reporting.component.scss"],
})
export class CounterfeitReportingComponent implements OnInit, OnDestroy {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
  ...
  getChart1() {
    ...
    let chart = am4core.create("chartdivcounterfeitreport1", am4charts.XYChart);
  ...
  getChart2() {
    ...
    let chart = am4core.create("chartdivcounterfeitreport2", am4charts.XYChart);
  ...
  getChart3() {
    let chart = am4core.create("chartdivcounterfeitreport3", am4charts.XYChart);
  ...
  getChart4() {
    let chart = am4core.create("chartdivcounterfeitreport4", am4charts.XYChart);
  ...
  getChart5() {
    let chart = am4core.create("chartdivcounterfeitreport5", am4charts.XYChart);
  ...
  getChart6() {
    let chart = am4core.create("chartdivcounterfeitreport6", am4charts.XYChart);
