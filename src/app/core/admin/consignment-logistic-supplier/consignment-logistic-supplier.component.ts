...
@Component({
  selector: "app-consignment-logistic-supplier",
  templateUrl: "./consignment-logistic-supplier.component.html",
  styleUrls: ["./consignment-logistic-supplier.component.scss"],
})
export class ConsignmentLogisticSupplierComponent implements OnInit, OnDestroy {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
  ...
  getChartConsLogSupplier1() {
    ...
    let chart = am4core.create("chartdivadminconlogsupplier1", am4charts.XYChart);
  ...
  initCalendar() {
    this.calendar = new Calendar(
      document.getElementById("calendarAdminConsigmentLogisticSupplier1"),
      {
