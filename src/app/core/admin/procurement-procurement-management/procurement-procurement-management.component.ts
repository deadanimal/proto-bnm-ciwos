...
@Component({
  selector: "app-procurement-procurement-management",
  templateUrl: "./procurement-procurement-management.component.html",
  styleUrls: ["./procurement-procurement-management.component.scss"],
})
export class ProcurementProcurementManagementComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
