...
@Component({
  selector: "app-submission-coin-stock",
  templateUrl: "./submission-coin-stock.component.html",
  styleUrls: ["./submission-coin-stock.component.scss"],
})
export class SubmissionCoinStockComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
