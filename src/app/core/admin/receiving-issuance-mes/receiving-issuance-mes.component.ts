...
@Component({
  selector: "app-receiving-issuance-mes",
  templateUrl: "./receiving-issuance-mes.component.html",
  styleUrls: ["./receiving-issuance-mes.component.scss"],
})
export class ReceivingIssuanceMesComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
  ...
  initCalendar() {
    this.calendar = new Calendar(
      document.getElementById("calendarAdminReceivingIssuanceMES1"),
      {
